...
function Exam() {
  ...
  const cardData = [
    ...
    },
    {
      ...
      description: "A test used to measure the English language ability of non-native speakers wishing to enroll in English-speaking universities.",
      img: tofel,
    },
    {
      name: "Graduate Management Admission Test (GMAT)",
      description: "A computer adaptive test intended to assess certain analytical, writing, quantitative, verbal, and reading skills in written English for use in admission to a graduate management program.",
      img: gmat,
    },
    {
      name: "Graduate Record Examination (GRE)",
      description: "A standardized test used to get admissions in various graduate schools or business graduate schools in various English-speaking countries.",
      img: gre,
    },
    {
      name: "International English Language Testing System (IELTS)",
      description: "An international standardized test of English language proficiency for non-native English language speakers.",
      img: ielts,
    },
    {
      name: "Medical College Admission Test (MCAT)",
      description: "A computer-based standardized examination for prospective medical students in the United States, Australia, Canada, and Caribbean Islands.",
      img: mcat
    },
    {
      name: "Law School Admission Test (LSAT)",
      description: "A half-day standardized test required for admission to JD programs at many law schools.",
      img: lsat,
    },
  ];
                ...
                <div className="relative h-full w-full rounded-xl shadow-xl transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                  ...
                  <div className="absolute inset-0">
                    ...
                    <img
                      ...
                      alt=""
                    />
                      <div className="font-bold text-[#FB2465] upercase">   {card.name}</div>
                  ...
                  <div className="absolute inset-0 h-full w-full rounded-xl card-exam  text-center  [transform:rotateY(180deg)] [backface-visibility:hidden]">
                    <div className="flex  flex-col items-center justify-center p-5">
                      <h1 className="text-base font-bold text-[#FB2465]">{card.name}</h1>
                      <p className="text-black text-sm mt-3 ">{card.description}</p>
                    </div>
                  </div>
                </div>
              </div>
